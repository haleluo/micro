...
import (
	...
	"github.com/haleluo/micro/v2/api/handler/rpc"
	"github.com/haleluo/micro/v2/api/router"
	rregistry "github.com/haleluo/micro/v2/api/router/registry"
	rstatic "github.com/haleluo/micro/v2/api/router/static"
