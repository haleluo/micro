...
import (
	...
	"fmgo.io/microv2/go-micro/v2/api/handler/rpc"
	"fmgo.io/microv2/go-micro/v2/api/router"
	rregistry "fmgo.io/microv2/go-micro/v2/api/router/registry"
	rstatic "fmgo.io/microv2/go-micro/v2/api/router/static"
